<a href="{{ route('galeri-album.edit',$galeri_album->id) }}"><button type="button" class="btn btn-primary waves-effect waves-light btn_edit"><i class="fas fa-edit">Detail</i></i></button></a>
