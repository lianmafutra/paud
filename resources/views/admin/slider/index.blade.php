        ...
        <div class="card">
            <div class="card-header">
                <h3 style="padding-top: 10px" class="card-title">
                    <i class="fas fa-chart-pie mr-1"></i>slider</h3>
               <a href="{{ route('slider.create') }}"><button type="button" class="btn_tambah btn btn-primary waves-effect waves-light"
                    style="float:right ;right: 10px; z-index: 40">Tambah slider</button></a>
            </div>
            <div class="card-body">

                <div class="table-responsive">
                  <table id="tabel_slider" class="table-bordered table table-hover row-border nowrap"
...
<script>
    ...
    $.ajaxSetup({
        ...
        let table_slider = $("#tabel_slider").DataTable({
            processing: true,
            deferRender: true,
            serverSide: true,
        ...
        //destroy
           $(document).on('click', '.btn_delete', function (e) {
            e.preventDefault();
            let data =  $('#tabel_slider').DataTable().row( $(this).parents('tr')).data();
