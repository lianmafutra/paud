      ...
      <div class="card">
          <div class="card-header">
              <h3 style="padding-top: 10px" class="card-title">
                  <i class="fas fa-chart-pie mr-1"></i>Buat Pendaftaran
              </h3>
          </div>
          <div class="card-body">
              @if ($errors->any())
              ...
              <form action="{{ route('tahun-ajaran.store') }}" method="POST">
                  ...
                  <div class="col-lg-6 ">
                      <div class="form-group">
                          ...
                          <input required value="{{old("priode_tahun ") }}" placeholder="" name="priode_tahun" type="text" 
                      ...
                      <div class="form-group">
                        ...
                        <input required value="{{old("priode_bulan") }}" placeholder="" name="priode_bulan" type="text" 
                            class="input form-control">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input required value="{{old("kuota_kb") }}" placeholder="" name="kuota_kb" type="text"
                            class="input form-control">
                    </div>
