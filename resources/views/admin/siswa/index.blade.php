        ...
        <div class="card">
            <div class="card-header">
                <h3 style="padding-top: 10px" class="card-title">
                    <i class="fas fa-chart-pie mr-1"></i>siswa</h3>
               <a href="{{ route('siswa.create') }}"><button type="button" class="btn_tambah btn btn-primary waves-effect waves-light"
                    style="float:right ;right: 10px; z-index: 40">Add siswa</button></a>
            </div>
            <div class="card-body">

                <div class="table-responsive">
                  <table id="table-siswa" class="table-bordered table table-hover row-border nowrap"
...
{data : 'gambar'},
        ...
        //destroy
           $(document).on('click', '.btn_delete', function (e) {
            e.preventDefault();
            let data =  $('#table-siswa').DataTable().row( $(this).parents('tr')).data();
