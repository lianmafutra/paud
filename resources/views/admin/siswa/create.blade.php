      ...
      <div class="card">
          <div class="card-header">
              <h3 style="padding-top: 10px" class="card-title">
                  <i class="fas fa-chart-pie mr-1"></i> Create Data Siswa
              </h3>
          </div>
          <div class="card-body">
              @if ($errors->any())
              ...
              <form action="{{ route('siswa.store') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-lg-6 ">
                      <div class="form-group">
                          ...
                          <input value="{{old("nama ") }}" placeholder="" name="nama" type="text" id="nama"
                              class="input form-control">
                      </div>
                      <div class="form-group">
                          <label>siswa</label>
                          <textarea id="desc" name="desc" class="form-control" rows="3" placeholder=""
                              style="margin-top: 0px; margin-bottom: 0px; height: 99px;">{{old("desc")}}</textarea>
                      </div>
                      <div class="form-group">
                          <label>Upload gambar <span style="font-size: 10px; color:#ff7272; font-style : italic"> (Jenis
                                  file : jpg, png | Max : 100kb)</span> </label>
                          <input type="file" data-max-file-size="100kb" class="filepond" accept="image/jpeg, image/png"
                              name="gambar">
                      </div>
                      <div class="form-group">
                          <label>Upload gambar2 <span style="font-size: 10px; color:#ff7272; font-style : italic">
                                  (Jenis file : jpg, png | Max : 100kb)</span> </label>
                          <input type="file" data-max-file-size="100kb" class="filepond" accept="image/jpeg, image/png"
                              name="gambar2">
                      </div>
                  </div>
          ...
          <div class="card-footer">
              <a class="btn btn-success waves-effect waves-light"
                  ...
                  href="{{ route('siswa.index') }}">Back</a>
              <button type="submit" class="btn_save btn btn-primary waves-effect waves-light"
                  style="float:left ;right: 10px; z-index: 40">Save</button>
          </div>
          </form>
      </div>
  </section>
