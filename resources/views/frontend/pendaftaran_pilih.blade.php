		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<table style="width:100%">
					...
					@foreach ($paket_tpa as $item)
					<tr>
						<td >
							<p><strong>{{ $item->nama }}</strong></p>
							{!! $item->deskripsi !!}
						</td>
						<td><a href="{{ url('pendaftaran/proses/tpa/'. $item->id) }}"><button class="button2">Pilih</button></a></td>
					</tr>
			...
			<div class="modal-footer">
				<button aria-haspopup="true" aria-expanded="false" type="button"
					class="btn btn-secondary  dropdown-toggle" data-dismiss="modal">Tutup</button>
											...
											<div class="panel price panel-green">
												...
												<div class="panel-footer">
													{{-- <a class="btn btn-lg btn-block btn-success"
														...
														class="btn btn-lg btn-block btn-success" href="#">Daftar</a>
												</div>
