                            ...
                            <div style="margin-top: 20px">
                                <form id="form_pendaftaran" method="POST" action="{{ url('pendaftaran/kirim') }}">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="form-group">
                                            <p for="exampleFormControlSelect1">Status Ibu<span
                                                    class="simbol_wajib">*</span> </p>
...
@push('js')
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.3.2/html2canvas.min.js" crossorigin="anonymous"
